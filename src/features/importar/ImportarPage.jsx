...
import { api, request } from "../../core/http/api";
...
function ImportarPage() {
          ...
          if (dbKey === "nombre") {
            ...
            if (sectorLower && !sectores[sectorLower]) {
              try {
                ...
                console.error("Error al crear sector", sectorName, e);
              }
            }
  ...
  const handleImport = useCallback(async () => {
    ...
    const existing = await request("/asociadas?select=id,nombre,telefono,lat,lng,sectores(nombre)&order=id.asc");
